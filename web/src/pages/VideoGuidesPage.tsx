...
const GUIDES: VideoGuide[] = [
  { id: 1, title: 'How to Use a Male Condom Correctly', description: 'Step-by-step guide to correct condom use for maximum protection.', duration: '3:03', category: 'condom_use', views: 1250, color: 'purple' },
  { id: 2, title: 'Understanding Oral Contraceptives', description: 'What you need to know about the pill — how it works and what to do if you miss a dose.', duration: '4:05', category: 'contraception', views: 890, color: 'purple' },
  ...
  { id: 5, title: 'Emergency Contraception (Morning-After Pill)', description: 'When and how to use emergency contraception, common myths debunked.', duration: '2:40', category: 'contraception', views: 3200, color: 'purple' },
...
function colorClasses(color: string) {
  ...
  return { bg: 'bg-purple-50', icon: 'text-purple-600', btn: 'bg-purple-600 hover:bg-purple-700' }
}
...
export default function VideoGuidesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Video Guides</h1>
        ...
        {CATEGORIES.map((cat) => (
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${
              active === cat ? 'bg-purple-600 text-white' : 'bg-white border border-gray-200 text-gray-600 hover:border-purple-300'
            }`}
          >
            {cat}
          </button>
